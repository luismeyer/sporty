<template>
  <div v-if="isAuthenticated" class="footer-container">
    <router-link v-if="hasSession" v-slot="{ isActive }" class="link" to="/">
      ...
      <span :class="{ active: isActive }">Session</span>
    </router-link>
    ...
    >
      ...
      <span :class="{ active: isActive }">Queue</span>
    </router-link>
    ...
    >
      ...
      <span :class="{ active: isActive }">Search</span>
    </router-link>
  </div>
</template>
...
export default defineComponent({
  setup() {
    ...
    return {
      ...
      hasSession: computed(() => Boolean(state.session.session)),
    };
  },
});
</script>
